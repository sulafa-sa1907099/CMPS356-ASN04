...
export default function Ideas() {
    ...
    useEffect(() => {
        if (!user)
            axios.get("sulafa1907099-asn04-39ar740ud-sulafa-sa1907099.now.sh/identifier").then(res => setUser(res.data))
    ...
    const ideasAddMutation = useMutation((idea) => axios.post(`sulafa1907099-asn04-39ar740ud-sulafa-sa1907099.now.sh/${user}/ideas`, idea),
    {
        onSuccess: () => {
