...
export default function Ideas() {
    ...
    useEffect(() => {
        if (!user)
            axios.get("http://sulafa1907099-asn04-8fj6eblsk-sulafa-sa1907099.vercel.app/api/identifier").then(res => setUser(res.data))
    ...
    const ideasAddMutation = useMutation((idea) => axios.post(`http://sulafa1907099-asn04-8fj6eblsk-sulafa-sa1907099.vercel.app/api/${user}/ideas`, idea),
    {
        onSuccess: () => {
